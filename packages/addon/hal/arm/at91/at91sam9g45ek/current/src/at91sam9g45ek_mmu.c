...
//      at91sam9g45ek_mmu.c
//
//      HAL board support code for Atmel AT91SAM9G45-EK board.
//
//==========================================================================
...
hal_mmu_init(void)
{
    ...
    //                  xxx00000  xxx00000
    ARC_X_ARM_MMU_PAGE_TABLE(0x70000000,   0x70000000, (unsigned)&__ram_data_start, 0x78000000, page_table, ARC_ARM_CACHEABLE, ARC_ARM_BUFFERABLE, ARC_ARM_ACCESS_PERM_RO_RO, ARC_ARM_ACCESS_PERM_RW_RW); // cached RAM
    ARC_X_ARM_MMU_SECTION(0x700,  0xB00,   128,  ARC_ARM_UNCACHEABLE, ARC_ARM_UNBUFFERABLE, ARC_ARM_ACCESS_PERM_RW_RW); // uncached RAM
    ...
    ARC_X_ARM_MMU_FINE_TABLE(0xFFFFE000,   0xFFFFE000, 0x00000000, fine_table, ARC_ARM_UNCACHEABLE, ARC_ARM_UNBUFFERABLE, ARC_ARM_ACCESS_PERM_RW_RW); // System Controller
}

//--------------------------------------------------------------------------
// EOF at91sam9g45ek_mmu.c
