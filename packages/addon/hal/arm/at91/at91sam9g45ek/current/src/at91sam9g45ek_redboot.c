/*==========================================================================
//
//      at91sam9g45ek_redboot.c
//
//      Redboot support code for Atmel AT91SAM9G45-EK board
//
//==========================================================================
...
/* Kick the watchdog. */
static void
at91sam9g45ek_kick_watchdog(bool is_idle)
{
...
RedBoot_idle(at91sam9g45ek_kick_watchdog, RedBoot_IDLE_BEFORE_NETIO);

/* Watchdog command for Redboot. */
static void
at91sam9g45ek_cmd_watchdog(int argc, char *argv[])
{
    cyg_uint32 reg_val;
...
static void
at91sam9g45ek_check_dipswitches(void)
{
...
RedBoot_init(at91sam9g45ek_check_dipswitches,  RedBoot_INIT_PRIO(500));
#endif // ifdef CYGFUN_REDBOOT_BOOT_SCRIPT

#endif // ifdef CYGPKG_REDBOOT

//--------------------------------------------------------------------------
// EOF at91sam9g45ek_redboot.c
