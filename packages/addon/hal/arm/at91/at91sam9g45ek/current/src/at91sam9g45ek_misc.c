/*==========================================================================
//
//      at91sam9g45ek_misc.c
//
//      HAL misc board support code for Atmel AT91SAM9G45-EK board
//
//==========================================================================
...
hal_plf_hardware_init (void)
{
  ...
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PD0, 1);
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PD31, 1);
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PD30, 1);
  HAL_ARM_AT91_GPIO_CFG_DIRECTION(AT91_GPIO_PD0, AT91_PIN_OUT);
  HAL_ARM_AT91_GPIO_CFG_DIRECTION(AT91_GPIO_PD31, AT91_PIN_OUT);
  HAL_ARM_AT91_GPIO_CFG_DIRECTION(AT91_GPIO_PD30, AT91_PIN_OUT);
  HAL_ARM_AT91_GPIO_CFG_PULLUP(AT91_GPIO_PD0, AT91_PIN_PULLUP_DISABLE);
  HAL_ARM_AT91_GPIO_CFG_PULLUP(AT91_GPIO_PD31, AT91_PIN_PULLUP_DISABLE);
  HAL_ARM_AT91_GPIO_CFG_PULLUP(AT91_GPIO_PD30, AT91_PIN_PULLUP_DISABLE);

  /* Configure IO pins for push-button switches.*/
  HAL_ARM_AT91_GPIO_CFG_PULLUP(AT91_GPIO_PB6, AT91_PIN_PULLUP_ENABLE);
  HAL_ARM_AT91_GPIO_CFG_PULLUP(AT91_GPIO_PB7, AT91_PIN_PULLUP_ENABLE);
  HAL_ARM_AT91_GPIO_CFG_DIRECTION(AT91_GPIO_PB6, AT91_PIN_IN);
  HAL_ARM_AT91_GPIO_CFG_DIRECTION(AT91_GPIO_PB7, AT91_PIN_IN);

  /* Enable peripheral clock to PIOA and PIOB and PIOC and PIOD/E. */
  HAL_WRITE_UINT32(AT91_PMC + AT91_PMC_PCER,
                   AT91_PMC_PCER_PIOA | AT91_PMC_PCER_PIOB | AT91_PMC_PCER_PIOC | AT91_PMC_PCER_PIOD);
...
// The AT91SAM9G20-EK board has 3 LEDs attached to GPIOs.
static void
hal_at91sam9g45ek_led (int val)
{
  // Turn LEDs on or off.
  // The logic is inverted for the user LED.
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PD0, !(val & 1));
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PD31, !(val & 2));
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PD30, val & 4);
}

void
hal_at91_set_leds(int val)
{
  hal_at91sam9g45ek_led(val);
}

// The AT92SAM9G45 board has 2 user push-buttons attached to GPIOs.
static cyg_uint32
hal_at91sam9g45_pushbutton(void)
{
  cyg_uint32 pb0, pb1;

  HAL_ARM_AT91_GPIO_GET(AT91_GPIO_PB6, pb0);
  HAL_ARM_AT91_GPIO_GET(AT91_GPIO_PB7, pb1);
...
{
  return hal_at91sam9g45_pushbutton();
}

//--------------------------------------------------------------------------
// EOF at91sam9g45ek_misc.c
