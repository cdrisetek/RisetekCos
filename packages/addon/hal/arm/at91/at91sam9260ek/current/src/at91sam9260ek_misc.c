/*==========================================================================
//
//      at91sam9260ek_misc.c
//
//      HAL misc board support code for Atmel AT91SAM9260-EK board
//
//==========================================================================
...
hal_plf_hardware_init (void)
{
  ...
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PA6, 1);
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PA9, 1);
  HAL_ARM_AT91_GPIO_CFG_DIRECTION(AT91_GPIO_PA6, AT91_PIN_OUT);
  HAL_ARM_AT91_GPIO_CFG_DIRECTION(AT91_GPIO_PA9, AT91_PIN_OUT);
  HAL_ARM_AT91_GPIO_CFG_PULLUP(AT91_GPIO_PA6, AT91_PIN_PULLUP_DISABLE);
  HAL_ARM_AT91_GPIO_CFG_PULLUP(AT91_GPIO_PA9, AT91_PIN_PULLUP_DISABLE);
...
// The AT91SAM9260-EK board has 2 LEDs attached to GPIOs.
static void
hal_at91sam9260ek_led (int val)
{
  // Turn LEDs on or off.
  // The logic is inverted for the user LED.
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PA6, !(val & 1));
  HAL_ARM_AT91_GPIO_PUT(AT91_GPIO_PA9, val & 2);
}

void
hal_at91_set_leds(int val)
{
  hal_at91sam9260ek_led(val);
}

// The AT92SAM9G20 board has 2 user push-buttons attached to GPIOs.
static cyg_uint32
hal_at91sam9260_pushbutton(void)
{
  cyg_uint32 pb0, pb1;
...
{
  return hal_at91sam9260_pushbutton();
}

//--------------------------------------------------------------------------
// EOF at91sam9260ek_misc.c
