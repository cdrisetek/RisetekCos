/*==========================================================================
//
//      at91sam9260ek_redboot.c
//
//      Redboot support code for Atmel AT91SAM9260-EK board
//
//==========================================================================
...
{
    *start = (unsigned char *) CYGMEM_REGION_sdram;
    *end   = (unsigned char *) CYGMEM_REGION_sdram + CYGMEM_REGION_sdram_SIZE - BOOTLOADER_RAM_SIZE;
}
...
/* Kick the watchdog. */
static void
at91sam9260ek_kick_watchdog(bool is_idle)
{
...
RedBoot_idle(at91sam9260ek_kick_watchdog, RedBoot_IDLE_BEFORE_NETIO);

/* Watchdog command for Redboot. */
static void
at91sam9260ek_cmd_watchdog(int argc, char *argv[])
{
    cyg_uint32 reg_val;
