...
//      at91sam9g20ek_mmu.c
//
//      HAL board support code for Atmel AT91SAM9G20-EK board.
//
//==========================================================================
...
hal_mmu_init(void)
{
    unsigned long ttb_base   = 0x200000;               // SRAM0
    unsigned long fine_table = 0x300000;               // SRAM1
    unsigned long page_table = fine_table + ARC_ARM_SECOND_LEVEL_FINE_TABLE_SIZE;   // 0x301000
    unsigned long vector_table = page_table + ARC_ARM_SECOND_LEVEL_PAGE_TABLE_SIZE; // 0x301400
    unsigned long sram_end = vector_table + ARC_ARM_TINY_PAGE_SIZE;                 // 0x301800
    unsigned long i;
    ...
    memset((void *)fine_table, 0, sram_end - fine_table);
